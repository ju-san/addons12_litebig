		...
		%if o.purchase_type == 'import':
			<table cellpadding="2" class="header hmid font12px" style="padding-top: 10px; border-bottom: 0px solid black; width: 100%">
	            ...
	            <tr>
		           ...
		           <td class="hleft font12px" width="10%">No. RFQ</td>
     	...
     	%else
     		<table cellpadding="2" class="header hmid font12px" style="padding-top: 10px; border-bottom: 0px solid black; width: 100%">
	            <tr>
		        	<th colspan="4" class="hmid font16px">PERMINTAAN PENAWARAN </th>
	            </tr>
	            <tr>
	            	<td colspan="4"></br></td>
	            </tr>
	            ...
	            <tr>
		            <td colspan="4" class="hleft">Mohon diberikan penawaran atas barang dibawah ini :</td>
	            </tr>
	     	</table>
     	%endif
