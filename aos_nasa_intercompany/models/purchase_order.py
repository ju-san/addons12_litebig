...
class PurchaseOrder(models.Model): 
    ...
    auto_generated = fields.Boolean(string='Auto Generated PO', copy=False)
    auto_sale_order_id = fields.Many2one('sale.order', string='Source SO', readonly=True, copy=False)
