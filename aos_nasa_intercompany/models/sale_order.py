...
class SaleOrder(models.Model): 
    ...
    auto_generated = fields.Boolean(string='Auto Generated SO', copy=False)
    auto_purchase_order_id = fields.Many2one('purchase.order', string='Source PO', readonly=True, copy=False)
    ...
    def _action_confirm(self):
        ...
        for order in self:
            ...
            if company and (not order.auto_generated):
