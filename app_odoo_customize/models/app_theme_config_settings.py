...
class AppThemeConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        app_documentation_url = ir_config.sudo().get_param('app_documentation_url',
                                                    default='http://www.klikodoo.id/documentation/user/12.0/en/index.html')
        app_documentation_dev_url = ir_config.sudo().get_param('app_documentation_dev_url',
                                                        default='http://www.klikodoo.id/documentation/12.0/index.html')
        app_support_url = ir_config.sudo().get_param('app_support_url', default='http://www.klikodoo.id/trial/')
        app_account_title = ir_config.sudo().get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.sudo().get_param('app_account_url', default='http://www.klikodoo.id/my-account/')
        return dict(
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_documentation_url",
                            self.app_documentation_url or "http://www.klikodoo.id/documentation/user/12.0/en/index.html")
        ir_config.set_param("app_documentation_dev_url",
                            self.app_documentation_dev_url or "http://www.klikodoo.id/documentation/12.0/index.html")
        ir_config.set_param("app_support_url", self.app_support_url or "http://www.klikodoo.id/trial/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "http://www.klikodoo.id/my/")
