...
# 
#     @api.model
#     def _get_group_reference(self, move_line):
#         res_model = ''
#         ref = ''
#         res_id = False
#         group_id = move_line.picking_id and move_line.picking_id.group_id
#         if group_id.sale_id:
#             res_model = 'sale.order'
#             res_id = group_id.sale_id.id
#             ref = group_id.sale_id.name
# #         elif group_id.purchase_id:
...
#         return usage
    ...
    def _make_dict_move(self, level, parent_id, move_line, unfoldable=False):
        ...
        #res_group_model, res_group_id, ref_group = self._get_group_reference(move_line)        
...
#                     or move_line.partner_id.ref or move_line.partner_id.name,
#             'location_destination': move_line.location_dest_id.usage == 'internal' and move_line.location_dest_id.name \
#                     or move_line.partner_id.ref or move_line.partner_id.name,
            'location_source': move_line.display_location_id,
            'location_destination': move_line.display_location_dest_id,
    ...
    def _final_vals_to_lines(self, final_vals, level):
        ...
        for data in final_vals:
            lines.append({
                ...
                #'res_group_id': data.get('res_group_id', False),
                #'res_group_model': data.get('res_group_model', False),
                'columns': [data.get('group_id', False),
