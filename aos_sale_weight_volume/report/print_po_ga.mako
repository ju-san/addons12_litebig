	...
	%for o in objects:
     ...
     <table class="font12px" style="border-bottom: 0px solid black; width: 100%">
	      ...
	      <td colspan="2">
		    ...
		    %if o.order_line|length < 20:
				%for bl in range (1,20-(o.order_line|length)):
					<tr>
						<td align="center" class="border_left_right">&nbsp;</td>
			...
			%endif
					<tr>
						<td align="center" class="border_left_right border_bottom">&nbsp;</td>
	            	...
	            	<tr class="font10px">
	            		...
	            		<td class="border_left_right border_top border_bottom hleft" style="width: 10%; padding:3px;" colspan="2"><b>SubTotal</b></td>
	            		<td class="border_left_right border_top border_bottom hright" style="width: 10%; padding:3px;"><b>${formatLang(o.amount_subtotal) or formatLang(0)}</b></td>
	            	</tr>
	            	<tr class="font10px">
	            		<td  style="width: 2%; padding:3px;"></td>
	            		
	            		<td class=" hmid" style="width: 13%; padding:3px;"></td>
	            		<td class="border_left_right border_bottom hleft" style="width: 10%; padding:3px;" colspan="2"><b>Diskon</b></td>
	            	...
	            	<tr class="font10px">
	            		...
	            		<td class=" hmid" style="width: 13%; padding:3px;"></td>
	            		<td class="border_left_right border_bottom hleft" style="width: 10%; padding:3px;" colspan="2"><b>Total</b></td>
            ...
            <tr>
	           <td class="hleft" style="padding-left: 5px"><pre>${o.notes or '-'}</pre> </td>
            </tr>
             <tr>
            ...
            <tr>
            	<td colspan="2">
	            	<table class="font12px one" style="width: 100%">
	            		...
	            		<tr>
	            			<td></td>
	            			<td class="border_top hmid">GA Manager</td>
	            			<td></td>
	            			<td class="border_top hmid">Commissioner</td>
	            			<td></td>
	            		</tr>
	            	</table>
	            </td>
